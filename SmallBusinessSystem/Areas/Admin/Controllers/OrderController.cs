...
namespace SmallBusinessSystem.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(CandyDbContext dbContext)
        {
        ...
        public IActionResult Details(int id)
        {
            ...
            IEnumerable<OrderDetail> orderDetails = _dbContext.OrderDetails.Where(o => o.OrderId == id).Include(od => od.Candy);
        ...
        public IActionResult UpdateOrderInformation()
        {
            ...
            orderFromDB.CustomerName = orderVM.Order.CustomerName; // puts in the value from the view into the DB
